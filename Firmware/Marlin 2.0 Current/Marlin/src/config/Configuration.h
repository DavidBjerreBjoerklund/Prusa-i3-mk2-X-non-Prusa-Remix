...
#define STRING_CONFIG_H_AUTHOR "(Frank Ideas, Trouble)" // Who made the changes.
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  #define  DEFAULT_Kp 18.17
  #define  DEFAULT_Ki 1.37
  #define  DEFAULT_Kd 60.36
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 732.1
  #define  DEFAULT_bedKi 228.96
  #define  DEFAULT_bedKd 585.22
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 640, 640, 3232, 587.93 }  //672.27
...
//#define NEOPIXEL_RGBW_LED
  ...
  #define NEOPIXEL_PIN    37       // D4 (EXP2-5 on Printrboard)
